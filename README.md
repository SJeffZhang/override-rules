...
本 Fork 在上游规则基础上，为“iNetS + 滕王阁 + 良心云”组合订阅增加了多个专用节点组，并将最终兜底策略组明确命名为“漏网之鱼”。

#### 专用节点组

| 代理组 | 节点匹配条件 | 当前样本节点数 |
| --- | --- | ---: |
| `香港-iNetS+滕王阁` | iNetS、滕王阁香港节点；排除实验性节点 | 动态 |
| `新加坡-iNetS+滕王阁` | iNetS、滕王阁新加坡节点；排除实验性节点 | 动态 |
| `日本-iNetS+滕王阁` | iNetS、滕王阁日本节点；排除实验性节点 | 动态 |
| `美国-iNetS+滕王阁` | 美国节点，但排除良心云节点 | 动态 |
...
`美国-iNetS+滕王阁` 会保留 iNetS、滕王阁等机场的美国节点，但剔除节点名中包含“良心云”的美国节点，适合在美国区服务中避开良心云线路。
...
[注册链接](https://api-inetscloud.com/aff.php?aff=4352)
