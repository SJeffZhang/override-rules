...
| 代理组 | 节点匹配条件 | 当前样本节点数 |
| --- | --- | ---: |
| `花云高级-亚洲AI` | 节点名称同时包含“花云”“高级”，且地区为台湾、新加坡或日本 | 9 |
| `花云高级-台湾` | 花云台湾高级节点 | 3 |
| `花云高级-新加坡` | 花云新加坡高级节点 | 3 |
| `花云高级-日本` | 花云日本高级节点 | 3 |
| `香港-花云+滕王阁` | 香港节点，且机场名称为花云或滕王阁；排除实验性节点 | 15 |
| `新加坡-花云+滕王阁` | 新加坡节点，且机场名称为花云或滕王阁；排除实验性节点 | 15 |
| `日本-花云+滕王阁` | 日本节点，且机场名称为花云或滕王阁；排除实验性节点 | 15 |
